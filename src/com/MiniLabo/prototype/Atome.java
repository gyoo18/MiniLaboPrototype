...
public class Atome{
    ...
    /**Électronégativité de l'atome. Peut varier avec le nombre d'électrons. */
    public float électronégativité = 0;

    /**Indexe de cet atome dans la liste de la simulation. */
    public int indexe = -1;

    //État des doublets
    /**Position des doublets. Relatif au noyeau. */
    public ArrayList<Vecteur3D> positionDoublet = new ArrayList<>();
    /**Position des doublets à temps t-1. Relatif au noyeau. */
    public ArrayList<Vecteur3D> prevPosDoublet  = new ArrayList<>();
    ...
    * Est <b>-1</b> s'il n'y a aucune liaison.*/
    public ArrayList<Integer> liaisonIndexe  = new ArrayList<>();
    /**Types de liaisons. L'indexe est lié à celui de <b><code>liaisonIndexe</code></b>. Sigma = <b>faux</b>, Pi = <b>vrai</b>. */
    public ArrayList<Boolean> liaisonType  = new ArrayList<>();
    /**Ordres de liaisons. L'indexe est lié à celui de <b><code>liaisonIndexe</code></b>. <b>1</b> = liaison simple, <b>2</b> = liaison double, <b>3</b> = liaison triple.*/
    ...
    /**Nombre de doublets électroniques de cet atomes. */
    public int doublets;
    /**Rayon covalent d'ordre 1 de cet atome */
    ...
    */
    public static void ÉvaluerForces(Atome A){
        ...
        double ModuleFriction = -0.000000000002;
    ...
    private static Vecteur3D ForcePaulie(double RayonCovalent1, double RayonCovalent2, double dist, Vecteur3D dir){
        return ( Vecteur3D.mult(dir, (2*Math.pow(2.0*(RayonCovalent1+RayonCovalent2),13.0)/Math.pow(dist,13.0)) ));
    }
    ...
    private static Vecteur3D ForceVanDerWall(int NP, int indexeA, int NPA, int indexeB, double dist, Vecteur3D dir){
        ...
        double module = Keesom + Debye + London;                      //Module des forces de Van der Walls.
        return ( Vecteur3D.mult(dir, -6.0*module/Math.pow(dist,7.0)));
    }
    ...
    /**Calcule l'électronégativité de cet atome en utilisant l'électronégativité d'Allred-Rochow et la règle de Slater. 
     * L'électronégativité est affectée par le nombre d'électrons. 
     * <p><a href="https://link.springer.com/article/10.1007/s00214-009-0610-4"> Source : <i>D. C. Ghosh et al.</i> (2009) The Electronegativity Scale of Allred and Rochow : Revisited</a></p>.
     * */
